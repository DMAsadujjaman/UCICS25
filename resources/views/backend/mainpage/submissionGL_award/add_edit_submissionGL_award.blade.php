                    ...
                    <div class="card">
                        {{-- <div class="card-header">
                            <h3>
                                @if (isset($editData))
                                    @if ($sgl->page == 'SGL')
                                        <h3>Edit Submission Guide Line</h3>
                                        <a class="btn btn-success float-right btn-sm" href="{{ route('submission.view') }}"><i
                                                class="fa fa-list"></i>
                                            List</a>
                                    @else
                                        <h3>Edit Student Paper Award</h3>
                                        <a class="btn btn-success float-right btn-sm" href="{{ route('award.view') }}"><i
                                                class="fa fa-list"></i>
                                            List</a>
                                    @endif
                                @else
                                    ...
                                    @if ($sgl->page == 'SGL')
                                        <h3>Add Submission GuideLine</h3>

                                    @else
                                        <h3>Add Student Paper Award</h3>
                        ...
                        <div class="card-header">
                            <h3>
                                @if (isset($editData))
                                    @if ($editData->page == 'SGL') <!-- Check against $editData to reflect what's being edited -->
                                        <h3>Edit Submission Guide Line</h3>
                                        <a class="btn btn-success float-right btn-sm" href="{{ route('submission.view') }}">
                                            <i class="fa fa-list"></i> List
                                        </a>
                                    @else
                                        <h3>Edit Student Paper Award</h3>
                                        <a class="btn btn-success float-right btn-sm" href="{{ route('award.view') }}">
                                            <i class="fa fa-list"></i> List
                                        </a>
                                    @endif
                                @else
                                    @if ($editData->page == 'SGL') <!-- Check $sgl if adding new "SGL" -->
                        ...
                        <div class="card-body">
                            <form method="POST"
                                action="{{ @$editData ? route('submission.update', $editData->id) : route('submission.store') }}"
