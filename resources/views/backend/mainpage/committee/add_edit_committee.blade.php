                            ...
                            <form method="POST"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-12">
                                            <label for="affiliation">Affiliation<font style="color: red;">*</font></label>
                                            <input type="text" class="form-control form-control-sm" name="affiliation"
                                                value="{{ @$editData['affil'] }}" placeholder="Enter Affiliation">
                                        </div>
                                        <div class="form-group col-md-12">
                                            ...
                                            <select class="form-control form-control-sm" name="committee" id="committee" required>
                                                ...
                                                <option value="Organizing Committee" {{ @$editData['committee'] == 'Organizing Committee' ? 'selected' : '' }}>Organizing Committee</option>
                                                <option value="Advisory Committee" {{ @$editData['committee'] == 'Advisory Committee' ? 'selected' : '' }}>Advisory Committee</option>
                                                <option value="Technical Committee" {{ @$editData['committee'] == 'Technical Committee' ? 'selected' : '' }}>Technical Committee</option>
                                                <option value="Registration Committee" {{ @$editData['committee'] == 'Registration Committee' ? 'selected' : '' }}>Registration Committee</option>
                                            </select>
