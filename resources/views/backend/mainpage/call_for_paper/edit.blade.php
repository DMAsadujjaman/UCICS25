    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Manage Call For Paper</h1>
                    </div><!-- /.col -->
                ...
                <div class="row">
                    ...
                    <section class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3>
                                    ...
                                    @else
                                        Add Call For Paper
                                    @endif
                                    <a class="btn btn-success float-right btn-sm" href="{{ route('call_fp.view') }}"><i
                            ...
                            <div class="card-body">
                                <form method="POST"
                                    action="{{ @$editData ? route('call_fp.update', $editData->id) : route('call_fp.store') }}"
